...
public class Workday extends BasePOM {
	...
	By btnOfcStuEmp = By.xpath(
			"/html/body/div[2]/div/div[2]/div[1]/section/div/div/div/div[1]/div/div[2]/div/div[2]/div[2]/div/div[2]/div/div[4]/div[1]/div/div/div[2]/div/div[3]/ul/li/div/div/div");
	...
	By btnAddEmp = By.xpath(
			"/html/body/div[3]/div[6]/form/table[2]/tbody/tr[2]/td[2]/table/tbody/tr[3]/td/table/tbody/tr[1]/td[5]/button");
	...
	By btnAddCat = By.xpath(
			"/html/body/div[3]/div[6]/form/table[2]/tbody/tr[2]/td[2]/table/tbody/tr[3]/td/table/tbody/tr[2]/td[5]/button");
	...
	By btnAddTF = By.xpath(
			"/html/body/div[3]/div[6]/form/table[2]/tbody/tr[2]/td[2]/table/tbody/tr[3]/td/table/tbody/tr[3]/td[5]/button");
	...
	public void btnCatName() throws IOException {
		...
		executeAction(Thread.currentThread().getStackTrace()[1].getMethodName(), driver.findElement(btnCatName),
				"click", "");
	}

	public void btnAddCat1() throws IOException {
		wait.until(ExpectedConditions.elementToBeClickable(btnAddCat1));
		executeAction(Thread.currentThread().getStackTrace()[1].getMethodName(), driver.findElement(btnAddCat1),
				"click", "");
	}

	public void btnSaveCat() throws IOException {
		wait.until(ExpectedConditions.elementToBeClickable(btnSaveCat));
		executeAction(Thread.currentThread().getStackTrace()[1].getMethodName(), driver.findElement(btnSaveCat),
				"click", "");
	}
	...
	public void btnCloseTF() throws IOException {
		...
		executeAction(Thread.currentThread().getStackTrace()[1].getMethodName(), driver.findElement(btnCloseTF),
				"click", "");
	}

	public void btnSaveSubs() throws IOException {
		wait.until(ExpectedConditions.elementToBeClickable(btnSaveSubs));
		executeAction(Thread.currentThread().getStackTrace()[1].getMethodName(), driver.findElement(btnSaveSubs),
				"click", "");
	}
